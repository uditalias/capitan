        ...
        render: function() {
            return <div className="flex-1 flex flex-vbox flex-align-center flex-pack-center height-max home-container">
                ...
                <div className="flex flex-pack-center margin-top-50">
                    <button className="btn btn-light margin-right-20" onClick={this._login}>
                        <div className="text-18 w300 padding-left-20 padding-right-20">login</div>
                    </button>
                    <button className="btn" onClick={this._signup}>
                        <div className="text-18 w300 padding-left-20 padding-right-20">signup</div>
                    </button>
                </div>
